...
| **[System-One Decision Lab](https://github.com/R3hmi/lab-ChatGPT-system-design)**  | `PyTorch` · `Calibration` · `Selective Prediction` · `OOD Detection` · `AI Routing` | JEV-inspired System-One decision models for fast, calibrated routing, selective abstention, risk scoring and hybrid small-model/LLM orchestration. |
